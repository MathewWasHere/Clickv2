...
(function () {
  ...
  function card(s) {
    ...
    el.classList.add(s.badge === 'محبوب‌ترین' ? 'border-primary/15' : 'border-[#111111]/5');
    var edited = !s.custom && P.serviceEdits()[s.id];
    el.innerHTML =
      '<div class="flex items-center justify-between mb-2">' +
      '<div class="flex items-center gap-2 flex-wrap">' +
      '<h3 class="text-[#111111] text-sm font-semibold"></h3>' +
      ...
      '</div></div>' +
      (s.desc ? '<p class="text-[#111111]/40 text-[10px] leading-relaxed mb-2"></p>' : '') +
      '<div class="flex items-center gap-3 text-[10px] text-[#111111]/30">' +
